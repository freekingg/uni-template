        ...
        <view class="cmd-progress-inner" :style="setCircleStyle">
          ...
          <svg viewBox="0 0 100 100" class="cmd-progress-circle">
            <path
              ...
              fill-opacity="0"
              class="cmd-progress-circle-trail"
            ...
            <path
              ...
              :stroke-width="strokeWidth"
              fill-opacity="0"
              class="cmd-progress-circle-path"
          ...
          <block v-if="showInfo && !custom">
            <text class="cmd-progress-text" :title="setFormat">
              ...
              <!-- #ifndef H5 -->
              <text
                v-if="status == 'exception' || status == 'success' || setProgress == 100"
                :style="setCircleIcon"
              ></text>
              <!-- #endif -->
            </text>
...
export default {
  ...
  props: {
     ...
     */
    status: {
      validator: val => ['normal', 'success', 'exception', 'active'].includes(val),
      default: 'normal',
    },
    /**
     * 条线的宽度1-50，与width有关
  ...
  computed: {
    ...
    setCircle() {
      ...
      const svgToBase = `data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100' class='cmd-progress-circle'%3E%3Cpath d='${
        this.setCirclePath
      }' stroke='%23f3f3f3' stroke-linecap='${this.strokeShape}' stroke-width='${
        this.strokeWidth
      }' fill-opacity='0' class='cmd-progress-circle-trail' style='stroke-dasharray: ${
        len - (gapDeg || 0)
        ...
        this.strokeWidth
      }' fill-opacity='0' class='cmd-progress-circle-path' style='stroke: ${currentColor};stroke-dasharray: ${

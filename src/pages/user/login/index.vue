    ...
    <view class="content">
      ...
      <view class="other_login">
        <view class="login_icon">
          <u-icon size="50" name="weixin-fill" @tap="login_weixin"></u-icon>
        </view>
        <view class="login_icon">
          <u-icon size="50" name="weibo-circle-fill" @tap="login_weixin"></u-icon>
        </view>
        <view class="login_icon">
          <u-icon size="50" name="facebook-circle-fill" @tap="login_weixin"></u-icon>
        </view>
      </view>
...
export default {
  ...
  methods: {
    ...
    startLogin (e) {
      ...
      setTimeout(() => {
        const tokens = {
          access_token: 'fadsfafds',
          refresh_token: 'fadsfafds'
        }
        saveTokens(tokens.access_token, tokens.refresh_token)
        this.setUserAndState({ username: 'afadf' })
        uni.hideLoading()
        uni.reLaunch({
